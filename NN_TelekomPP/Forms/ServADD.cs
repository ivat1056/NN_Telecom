...
namespace NN_TelekomPP.Forms
{
    ...
    public partial class ServADD : Form // дво добавить 
    {
        public int razmer = 0;
        public static string[] add_add = new string[1];
        ...
        private void Save_button_Click(object sender, EventArgs e) // сохранение 
        {
            ...
            else
            {
                ...
                var addQuery = $"insert into ServicesADD(Name, Cost) values ('{textBox1.Text}','{textBox2.Text}')";
                var command = new SqlCommand(addQuery, dataBase.GetConnection());
                command.ExecuteNonQuery();
                MessageBox.Show("Запись успешно добавлена в таблицу");
                add_add[razmer] = textBox1.Text;
                Array.Resize(ref add_add, add_add.Length + 1);
                razmer++;
